...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_and_samples.py \
    --short_eval True \
    --model-path /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/LLaVA-RLHF-7b-v1.5-224/sft_model/ \
    --use-qlora True \
    --qlora-path /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/LLaVA-RL-Fact-RLHF-7b-v1.5-224-lora-padding/checkpoint-130/adapter_model/lora_policy/ \
    ...
    --answers-file answers/RL_con_random_sample.jsonl \
    --image_aspect_ratio pad \
    --test-prompt ''

CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_orders.py \
    --short_eval True \
    --model-path /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/LLaVA-RLHF-7b-v1.5-224/sft_model/ \
    --use-qlora True \
    --qlora-path /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/LLaVA-RL-Fact-RLHF-7b-v1.5-224-lora-padding/checkpoint-130/adapter_model/lora_policy/ \
    --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/LLaVA_heme_test_q.json \
    --image-folder /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/ \
    --answers-file answers/RL_con_random.jsonl \
    --image_aspect_ratio pad \
    --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_reverse_orders.py \
    ...
    --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/LLaVA_heme_test_q.json \
    --image-folder /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/ \
    --answers-file answers/RL_con_reverse.jsonl \
    --image_aspect_ratio pad \
    --test-prompt ''