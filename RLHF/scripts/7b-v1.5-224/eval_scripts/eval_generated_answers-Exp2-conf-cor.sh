...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_confir_cor.json \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2/SFT_CQ-R.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_confir_cor.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2/SFT_permutated_CQ-R.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py   --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_confir_cor.json   \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2/SFT_permutated_CQ-R_v0.jsonl  --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_confir_cor.json   \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2/SFT_permutated_CQ-R_v1.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py  --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_confir_cor.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2/SFT_permutated_CQ-R_v2.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py  --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_confir_cor.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2/SFT_permutated_CQ-R_v3.jsonl --image_aspect_ratio pad --test-prompt ''