...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_orders.py    --short_eval True    \
  ...
  --answers-file results/exp2_plus/SFT_conv_RI_eccv.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_orders.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2_plus/SFT_permutated_conv_RI_eccv.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_orders.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2_plus/SFT_permutated_conv_RI_v0.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_orders.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2_plus/SFT_permutated_conv_RI_v1.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_orders.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2_plus/SFT_permutated_conv_RI_v2.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_random_orders.py    --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp2_plus/SFT_permutated_conv_RI_v3.jsonl --image_aspect_ratio pad --test-prompt ''
