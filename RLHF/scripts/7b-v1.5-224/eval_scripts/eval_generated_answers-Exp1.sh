...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py    --short_eval True    \
  ...
  --question-file /wynton/protected/home/ichs/harrysun/radiology-fm/test_bccv_q_set2.json \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp1/SFT_set2.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py    --short_eval True    \
  ...
  --question-file /wynton/protected/home/ichs/harrysun/radiology-fm/test_bccv_q_set2.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp1/SFT_permutated_set2.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py   --short_eval True    \
  ...
  --question-file /wynton/protected/home/ichs/harrysun/radiology-fm/test_bccv_q_set2.json   \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp1/RL_permutated_v0_set2.jsonl  --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py    --short_eval True    \
  ...
  --question-file /wynton/protected/home/ichs/harrysun/radiology-fm/test_bccv_q_set2.json   \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp1/RL_permutated_v1_set2.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py  --short_eval True    \
  ...
  --question-file /wynton/protected/home/ichs/harrysun/radiology-fm/test_bccv_q_set2.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp1/RL_permutated_v2_set2.jsonl --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py  --short_eval True    \
  ...
  --question-file /wynton/protected/home/ichs/harrysun/radiology-fm/test_bccv_q_set2.json  \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp1/RL_permutated_v3_set2.jsonl --image_aspect_ratio pad --test-prompt ''