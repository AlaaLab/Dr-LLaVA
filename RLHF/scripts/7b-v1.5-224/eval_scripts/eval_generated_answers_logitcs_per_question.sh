...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_logit.py    --short_eval True     --model-path /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/LLaVA-RLHF-7b-v1.5-224/sft_model/    --use-qlora True --qlora-path /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/LLaVA-RL-INIT-7b-v1.5-224-lora-padding/lora_default/    --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/LLaVA_heme_test_q.json     --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  --answers-file answers/SFT_per_question_logics.jsonl --image_aspect_ratio pad --test-prompt ''