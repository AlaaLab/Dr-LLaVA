...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py   --short_eval True    \
  ...
  --answers-file results/exp3/RL_permutated_sqa_epoch20.jsonl  --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py   --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json   \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp3/RL_permutated_sqa_epoch30.jsonl  --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py   --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json   \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp3/RL_permutated_sqa_epoch40.jsonl  --image_aspect_ratio pad --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa.py   --short_eval True    \
  ...
  --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/test_bccv_q_big.json   \
  --image-folder  /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/  \
  --answers-file results/exp3/RL_permutated_sqa_epoch50.jsonl  --image_aspect_ratio pad --test-prompt ''