...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_confirmation_prior_question_wrong_hints.py \
    --short_eval True \
    ...
    --answers-file answers/SFT_con_wrong_hints.jsonl \
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_confirmation_prior_question_wrong_hints.py \
    ...
    --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/LLaVA_heme_test_q.json \
    --image-folder /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/ \
    --answers-file answers/SFT_con_permutated_wrong_hints.jsonl \
    --image_aspect_ratio pad \
    --test-prompt ''
...
CUDA_VISIBLE_DEVICES=$SGE_GPU python ../Eval/model_vqa_conversation_confirmation_prior_question_wrong_hints.py \
    ...
    --question-file /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/LLaVA_heme_test_q.json \
    --image-folder /wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/ucsf_data_rl/image_folder/ \
    --answers-file answers/RL_con_wrong_hints.jsonl \
    --image_aspect_ratio pad \
    --test-prompt ''
