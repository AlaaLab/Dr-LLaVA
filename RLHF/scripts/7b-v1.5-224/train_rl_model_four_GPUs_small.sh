...
POLICY_LORA=LLaVA-RL-INIT-7b-v1.5-224-lora-padding-permutate/lora_default
RM_LORA=LLaVA-Fact-RM-13b-v1.5-336-lora-padding/checkpoint-200  # we use early stopping

# SAVE CONFIG
MODEL_NAME=LLaVA-RL-Fact-RLHF-7b-v1.5-224-lora-padding-four-GPUs-small
...
REWARD_MODEL_PER_DEVICE_BATCH_SIZE=1
