...
def train():
    ...
    if model_args.vision_tower is not None:
        ...
        # Load resnet based clip encoder
        device = "cuda"
        ...
        vision_tower = timm.create_model(model_name, pretrained=True,pretrained_cfg_overlay={'file': '/wynton/protected/group/ibrahim/alex/Dr-LLaVA/checkpoints_timm/resnet50_clip.openai_checkpoint.pth'})
         # checkpoint_path='/wynton/protected/group/ibrahim/alex/Dr-LLaVA/checkpoints_timm/resnet50_clip.openai_checkpoint.pth')
        #model.eval()
