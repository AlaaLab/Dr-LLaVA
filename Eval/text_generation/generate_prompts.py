...
sys.path.append(
    "/wynton/protected/group/ibrahim/harry/LLaVA_checkpoints/LLaVA-RLHF/Eval/text_generation"
)
...
def random_a_answer_sample(category):
    ...
    ), f"the category is supposed to be in the ragne but it is not: {category}"
    answer_lists = []
    ...
    if category == "NORMAL":
        ...
        if logics[1] == 1:
            ...
            answer_lists.append(
                [
                    question_answers_set._sample("a_12"),
                    question_answers_set._sample("a_13"),
                ][_sample]
            )
        if logics[2] == 1:
            ...
            answer_lists.append(
                [
                    question_answers_set._sample("a_21"),
                    question_answers_set._sample("a_22"),
                    question_answers_set._sample("a_23"),
                ][_sample]
            )
        if logics[3] == 1:
            ...
            answer_lists.append(
                [
                    question_answers_set._sample("a_211"),
        ...
        if logics[4] == 1:
            ...
            answer_lists.append(
                [
                    question_answers_set._sample("a_2111"),
        ...
        if logics[2] == 1:
            ...
            answer_lists.append(
                [
                    question_answers_set._sample("a_23"),
                    question_answers_set._sample("a_24"),
                ][_sample]
            )
        if logics[3] == 1:
            ...
            answer_lists.append(
                [
                    question_answers_set._sample("a_221"),
                    question_answers_set._sample("a_231"),
                    question_answers_set._sample("a_241"),
                ][_sample]
            )
        if logics[4] == 1:
            ...
            answer_lists.append(
                [
                    question_answers_set._sample("a_2211"),
                    question_answers_set._sample("a_2311"),
                    question_answers_set._sample("a_2411"),
                ][_sample]
            )
...
def random_conterfactual_prior(category, p):
    ...
    assert p in [
        ...
        3,
        4,
    ], f"the actual value of p is {p}, which indicate it is not in the normal range"
    answer_lists = []
    question_answers_set = text_augmentation_repo()
    # (category)
