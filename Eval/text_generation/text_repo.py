...
class  text_augmentation_repo():
    ...
    def create_text_repo(self):
        self.text_repo['Observation'] = ['The prior assessment you made is',
 ...
 'The earlier examination you conducted is']
        ...
        self.text_repo['q_0'] = ['Examining these pathology images, can you determine if they can be utilized for cancer diagnosis?',
 ...
 'Considering these pathological photographs, can you verify if they can be used for cancer diagnosis purposes?',
        ...
        self.text_repo['a_01'] = ['This pathology image section can be effectively utilized for diagnostic purposes in the medical field',
 ...
 'This pathological picture section is apt for determining diagnoses in the medical field']
        self.text_repo['a_02'] = ['This pathological image segment cannot be utilized for accurate medical diagnosis purposes',
 ...
 'The given pathological image patch cannot be reliably utilized for cancer diagnosis purposes']
        self.text_repo['a_03'] = ['This pathological image segment cannot be utilized for accurate medical diagnosis purposes',
 'For cancer diagnosis purposes, these pathological photographs are not appropriate to use for conclusive determinations',
 'This pathological image segment cannot be utilized for accurate medical diagnosis',
 'The provided pathology image piece is inadequate for determining a cancer diagnosis',
 'For cancer diagnosis purposes, this particular pathology image section is unsuitable',
 ...
 'These pathology image patches are unsuitable for providing accurate medical diagnosis, particularly for cancer detection',
 'The given pathological image patch cannot be reliably utilized for cancer diagnosis purposes']
        self.text_repo['q_1'] = ["Could you provide a description of the pathology image patch's quality?",
 ...
 'Could you provide details on the quality of the pathology image section?']
        self.text_repo['a_11'] = ['The area is in proximity to aspirated particles containing a high percentage of marrow nucleated cells, making it optimal for diagnostic objectives',
 ...
 'The vicinity is adjacent to particles with a high proportion of marrow nucleated cells, which is highly suitable for diagnostic objectives']
        self.text_repo['a_12'] = ['The area exhibits a high concentration of red blood cells, making it unsuitable for accurate medical diagnosis',
 ...
 'With an abundance of RBCs present, the region appears bloody, making it less than ideal for accurate medical diagnosis']
        self.text_repo['a_13'] = ['The area displays a high concentration of dense aspirate particles, making it unsuitable for accurate medical diagnosis',
 ...
 'In this zone, there is a significant presence of dense aspirate particles, which negatively impacts the diagnostic process']
        self.text_repo['q_2'] = ['Can you identify any irregularities within the image patch that could potentially suggest the presence of a disease?',
 ...
 'Could you identify any irregularities in the image patch that may suggest the presence of a medical condition?']
        self.text_repo['a_21'] = ['The patch exhibits patterns indicative of malignancy',
 ...
 'The image patch displays patterns indicative of malignancy',
 'Malignant patterns are evident in the patch under examination']
        self.text_repo['q_21'] = ['Have you noticed any unusual cell growth within the image patch, and can you identify the specific cell type?',
 ...
 'Have you noticed any unusual cellular growth within the image section, and can you identify the specific cell type involved?']
        self.text_repo['a_211'] = ['The picture segment exhibits an atypical increase in Myeloblast cell numbers',
 ...
 'An irregular expansion of Myeloblast cells is observed in the visual snippet']
        self.text_repo['q_211'] = ['As a pathologist, would you be able to determine the possible blood cancer from the image patch provided?',
 'Can you pinpoint the probable illness depicted in this image patch, acting as a pathologist?','Could you discern the potential condition represented in the image patch?',
 ...
 'Could you recognize the probable condition displayed in the image fragment?']
        ...
        self.text_repo['a_2111'] = ['In this image patch, there is evidence suggestive of acute myeloid leukemia, as a pathologist might identify',
 ...
 'In the image patch, there is an indication of acute myeloid leukemia being present']
        ...
        self.text_repo['a_22'] = ['The patch exhibits patterns indicative of malignancy',
 'Malignant patterns are displayed in the patch',
 'The image patch displays patterns indicative of malignancy',
 'Malignant patterns are evident in the patch under examination',
 'The image patch displays malignant characteristics',
 ...
 'Malignant patterns are evident in the patch under examination']
        ...
        self.text_repo['q_22'] = ['Have you noticed any unusual cell growth within the image patch, and can you identify the specific cell type?',
 'Have you noticed any unusual cell growth in the image section, and can you identify the specific cell type?',
 'Have you noticed any unusual cell growth in the image section, and can you identify the specific cell type?',
 'Have you identified any unusual cell growth within the image patch, and if so, can you specify the cell type?',
 'Have you noticed any unusual cell growth within the image patch, and if so, can you identify the specific cell type?',
 ...
 'Have you noticed any unusual cellular growth within the image section, and can you identify the specific cell type involved?']
        ...
        self.text_repo['a_221'] = ['The picture segment exhibits an atypical increase in Plasma cell numbers',
 ...
 'An irregular expansion of Plasma cells is observed in the visual snippet']
        self.text_repo['q_221'] = ['As a pathologist, would you be able to determine the possible blood cancer from the image patch provided?',
 'Can you pinpoint the probable illness depicted in this image patch, acting as a pathologist?','Could you discern the potential condition represented in the image patch?',
 'Can you determine the possible illness depicted in this image section?',
 'Would you be able to recognize the probable disease present in the visual fragment as a pathologist?',
 'Can you pinpoint the potential disorder shown in the image piece?',
 ...
 'As a pathologist, are you able to pinpoint the likely ailment present in the image section?',
 'Could you recognize the probable condition displayed in the image fragment?']
        self.text_repo['a_2211'] = ['In this image patch, there is evidence suggestive of multiple myeloma, as a pathologist might identify',
 ...
 'In the image patch, there is an indication of multiple myeloma being present']
        ...
        self.text_repo['a_23'] = ['The quality of the image patch is inadequate, making it impossible to determine the presence of any irregularities that could indicate a medical condition',
 ...
 'Due to the low-quality image patch, it is unclear if any irregularities exist that may indicate a disease']
        self.text_repo['q_23'] = ['Have you noticed any unusual cell growth within the image patch, and can you identify the specific cell type?',
 'Have you noticed any unusual cell growth in the image section, and can you identify the specific cell type?',
 'Have you noticed any unusual cell growth in the image section, and can you identify the specific cell type?',
 'Have you identified any unusual cell growth within the image patch, and if so, can you specify the cell type?',
 'Have you noticed any unusual cell growth within the image patch, and if so, can you identify the specific cell type?',
 ...
 'Have you noticed any unusual growth of cells, and if so, can you identify the specific cell type?',
 'Have you noticed any unusual cellular growth within the image section, and can you identify the specific cell type involved?']
        self.text_repo['a_231'] = ['The quality of the image patch is insufficient, and there are not enough bone marrow cells visible to make a definitive determination',
 ...
 'Insufficient bone marrow cells are visible in the low-quality image patch, preventing a conclusive assessment']
        self.text_repo['q_231'] = ['As a pathologist, would you be able to determine the possible blood cancer from the image patch provided?',
 'Can you pinpoint the probable illness depicted in this image patch, acting as a pathologist?','Could you discern the potential condition represented in the image patch?',
 'Can you determine the possible illness depicted in this image section?',
 'Would you be able to recognize the probable disease present in the visual fragment as a pathologist?',
 'Can you pinpoint the potential disorder shown in the image piece?',
 ...
 'As a pathologist, are you able to pinpoint the likely ailment present in the image section?',
 'Could you recognize the probable condition displayed in the image fragment?']
        self.text_repo['a_2311'] = ['The picture segment is of low quality, making it unsuitable for accurate medical diagnosis',
 ...
 "The image patch's low quality renders it inappropriate for reliable diagnostic purposes"]
        ...
        self.text_repo['a_24'] = ['The image patch appears to be normal, with no observable irregularities present',
 ...
 'No irregularities can be discerned in the image patch, indicating a normal appearance']
        ...
        self.text_repo['q_24'] =  ['Have you noticed any unusual cell growth within the image patch, and can you identify the specific cell type?',
 'Have you noticed any unusual cell growth in the image section, and can you identify the specific cell type?',
 'Have you noticed any unusual cell growth in the image section, and can you identify the specific cell type?',
 'Have you identified any unusual cell growth within the image patch, and if so, can you specify the cell type?',
 'Have you noticed any unusual cell growth within the image patch, and if so, can you identify the specific cell type?',
 ...
 'Have you noticed any unusual growth of cells, and if so, can you identify the specific cell type?',
 'Have you noticed any unusual cellular growth within the image section, and can you identify the specific cell type involved?']
        self.text_repo['a_241'] = ['Based on my observation, the image patch does not display any abnormal cellular growth',
 ...
 'Upon examination, I cannot detect any abnormal cell proliferation within the image section']
        self.text_repo['q_241'] = ['As a pathologist, would you be able to determine the possible blood cancer from the image patch provided?',
 'Can you pinpoint the probable illness depicted in this image patch, acting as a pathologist?','Could you discern the potential condition represented in the image patch?',
 'Can you determine the possible illness depicted in this image section?',
 'Would you be able to recognize the probable disease present in the visual fragment as a pathologist?',
 'Can you pinpoint the potential disorder shown in the image piece?',
 ...
 'As a pathologist, are you able to pinpoint the likely ailment present in the image section?',
 'Could you recognize the probable condition displayed in the image fragment?']
        self.text_repo['a_2411'] = ['The visual segment reveals no evidence of blood cancer, and the individual is in good health',
